...
namespace Backend.Controllers
{
    ...
    public class AssetsController : ControllerBase
    {
        ...
        // Method to generate a report of assets active between two dates
        [HttpGet("report1")]
        public async Task<IActionResult> GenerateAssetReport(DateOnly startDate, DateOnly endDate)
        {
            try
            {
                var assets = await _context.Assets
                ...
                var reportData = assets.Select(a =>
                {
                    ...
                    if (a.AssetType == "Fixed Deposit" && a.FixedDeposit != null)
                    {
